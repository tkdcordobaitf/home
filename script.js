...
const tules = {
  ...
  dangun: {
    name: "Dan Gun",
    video: "",
    description: "Santo Legendario fundador de Corea en el 233 ac",
    belt: "Amarillo",
    diagram: "Doble T",
    qtyMovements: 21,
    movements: [],
  ...
  dosan: {
    ...
    video: "",
    description:
      "Seudónimo de Anh-Chan-Ho que luchó por la educación e independencia de Corea. Los 24 movimientos representan su vida.",
  ...
  wonhyo: {
    ...
    video: "",
    description:
      "Monje que introdujo el budismo durante la dinastía silla en el 686 dc.",
    belt: "Verde",
    diagram: "Doble T",
    qtyMovements: 28,
    movements: [],
